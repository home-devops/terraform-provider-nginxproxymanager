...
func (m *RedirectionHost) Load(ctx context.Context, resource *resources.RedirectionHost) diag.Diagnostics {
	...
	m.HSTSEnabled = types.BoolValue(bool(resource.HSTSEnabled))
	m.HSTSSubdomains = types.BoolValue(bool(resource.HSTSSubdomains))
	m.HTTP2Support = types.BoolValue(bool(resource.HTTP2Support))
